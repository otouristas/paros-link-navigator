...
const Index = () => {
  return (
    <>
      <SEO
        title="Paros Rent A Car | Best Car Rental Services in Paros Greece | Antiparos Rent A Car"
        description="Premium Paros rent a car services. Rent cars, scooters, ATVs, bikes & SUVs in Paros. Airport & port pickup available. Book with Antiparos Rent A Car - your trusted Paros car rental partner."
        canonicalUrl="http://rentacar-paros.gr"
        keywords="paros rent a car, rent a car paros, paros car rental, paros airport car rental, paros port car rental, antiparos rent a car, paros scooter rental, paros atv rental, paros bike rental, paros suv rental"
      />
